...
<table class="table table-sm">
  ...
  @foreach($adminusers as $adminuser)
    <tr>
      ...
      <td><a   href='{{route("admin.adminuser.state",[$adminuser->id])}}'>{!!$adminuser->stateText!!}</a></td>
      <td>
      <a  onclick='return confirm("确认更改吗")' class="btn btn-sm btn-secondary" href='{{route("admin.adminuser.add",[$adminuser->id])}}'>修改</a>
